...
import TmallExample from '../../components/smart/Chrome/TmallExample.js'
import './index.scss'

function Chrome() {
    let list = [
        {title: '天猫实例', Component: <TmallExample/>, className: 'display_flex'},
        {title: '通讯', Component: <Communication/>, className: 'display_flex'},
        {title: '本地存储', Component: <ChromeStorage/>, className: 'chromectx'},
